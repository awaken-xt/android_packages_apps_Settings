...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    private static final String KEY_AWAKENLAB = "top_level_awaken_lab";
    ...
    private void onSetPrefCard() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (key.equals("top_level_network")
                ...
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_top);
                ...
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_middle);
            } else if ("top_level_google".equals(key)){
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_bottom);
            } else if (key.equals("top_level_accounts") && gAppsExists){
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_middle);
            } else if (key.equals("top_level_awaken_lab")){
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_single);
            } else {
                preference.setLayoutResource(R.layout.awakenos_dashboard_preference_bottom);
            }
       }
    ...
    private void updateLabSummary() {
        Preference awakenlab = findPreference(KEY_AWAKENLAB);
        if (awakenlab != null) {
            String[] summaries = getContext().getResources().getStringArray(
                    R.array.awakenlab_summaries);
            Random rnd = new Random();
            int summNO = rnd.nextInt(summaries.length);
            awakenlab.setSummary(summaries[summNO]);
        }
    }
